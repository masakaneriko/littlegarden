<?php
/*
School Taxonomy Page for Blogs
*/
get_header();
?>
...
<section id="hero">
    <div class="hero-banner">
        ...
        <h1 class="hero-title"><?php single_term_title(); ?>ブログ</h1>
    </div>
</section>
...
<section>
    ...
    <div class="blog-button">
        <a class="button-green-md" href="<?php echo get_post_type_archive_link('blog'); ?>">ブログ一覧に戻る</a>
    </div>
